...
var DrainState_name = map[int32]string{
	0: "UNKNOWN",
	1: "DRAINING",
	2: "DRAINED",
}

var DrainState_value = map[string]int32{
	"UNKNOWN":  0,
	"DRAINING": 1,
	"DRAINED":  2,
}
...
func (x DrainState) String() string {
	return proto.EnumName(DrainState_name, int32(x))
}

func (x *DrainState) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(DrainState_value, data, "DrainState")
	if err != nil {
		return err
	}
	*x = DrainState(value)
...
var LinuxInfo_IpcMode_name = map[int32]string{
	0: "UNKNOWN",
	1: "PRIVATE",
	2: "SHARE_PARENT",
}

var LinuxInfo_IpcMode_value = map[string]int32{
	"UNKNOWN":      0,
	"PRIVATE":      1,
	"SHARE_PARENT": 2,
}
...
func (x LinuxInfo_IpcMode) String() string {
	return proto.EnumName(LinuxInfo_IpcMode_name, int32(x))
}

func (x *LinuxInfo_IpcMode) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(LinuxInfo_IpcMode_value, data, "LinuxInfo_IpcMode")
	if err != nil {
		return err
	}
	*x = LinuxInfo_IpcMode(value)
	return nil
}

func (LinuxInfo_IpcMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_9ae6ea93b6aa08a0, []int{68, 0}
}
...
type FrameworkInfo struct {
	...
	OfferFilters         map[string]*OfferFilters `protobuf:"bytes,13,rep,name=offer_filters,json=offer_filters" json:"offer_filters,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	XXX_NoUnkeyedLiteral struct{}                 `json:"-"`
	XXX_unrecognized     []byte                   `json:"-"`
	XXX_sizecache        int32                    `json:"-"`
}
...
type ResourceProviderInfo_Storage struct {
	...
	ReconciliationIntervalSeconds *float64 `protobuf:"fixed64,2,opt,name=reconciliation_interval_seconds,json=reconciliation_interval_seconds" json:"reconciliation_interval_seconds,omitempty"`
	XXX_NoUnkeyedLiteral          struct{} `json:"-"`
	XXX_unrecognized              []byte   `json:"-"`
	XXX_sizecache                 int32    `json:"-"`
}
...
func (m *ResourceProviderInfo_Storage) GetReconciliationIntervalSeconds() float64 {
	if m != nil && m.ReconciliationIntervalSeconds != nil {
		return *m.ReconciliationIntervalSeconds
	}
	return 0
}
...
type OfferFilters struct {
	MinAllocatableResources *OfferFilters_MinAllocatableResources `protobuf:"bytes,1,opt,name=min_allocatable_resources,json=min_allocatable_resources" json:"min_allocatable_resources,omitempty"`
	XXX_NoUnkeyedLiteral    struct{}                              `json:"-"`
	XXX_unrecognized        []byte                                `json:"-"`
	XXX_sizecache           int32                                 `json:"-"`
}
...
type Offer_Operation struct {
	...
	CreateDisk           *Offer_Operation_CreateDisk   `protobuf:"bytes,15,opt,name=create_disk,json=create_disk" json:"create_disk,omitempty"`
	DestroyDisk          *Offer_Operation_DestroyDisk  `protobuf:"bytes,16,opt,name=destroy_disk,json=destroy_disk" json:"destroy_disk,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                      `json:"-"`
	XXX_unrecognized     []byte                        `json:"-"`
	XXX_sizecache        int32                         `json:"-"`
}
...
type Offer_Operation_CreateDisk struct {
	...
	TargetProfile        *string  `protobuf:"bytes,3,opt,name=target_profile,json=target_profile" json:"target_profile,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type Task struct {
	...
	HealthCheck *HealthCheck   `protobuf:"bytes,15,opt,name=health_check,json=health_check" json:"health_check,omitempty"`
	...
	KillPolicy *KillPolicy `protobuf:"bytes,16,opt,name=kill_policy,json=kill_policy" json:"kill_policy,omitempty"`
...
func (m *Task) GetKillPolicy() *KillPolicy {
	if m != nil {
		return m.KillPolicy
	}
	return nil
...
type OperationStatus struct {
	...
	AgentId              *AgentID            `protobuf:"bytes,6,opt,name=agent_id,json=agent_id" json:"agent_id,omitempty"`
	ResourceProviderId   *ResourceProviderID `protobuf:"bytes,7,opt,name=resource_provider_id,json=resource_provider_id" json:"resource_provider_id,omitempty"`
	XXX_NoUnkeyedLiteral struct{}            `json:"-"`
	XXX_unrecognized     []byte              `json:"-"`
	XXX_sizecache        int32               `json:"-"`
}
...
type SeccompInfo struct {
	...
	ProfileName *string `protobuf:"bytes,1,opt,name=profile_name,json=profile_name" json:"profile_name,omitempty"`
...
type LinuxInfo struct {
	...
	CapabilityInfo *CapabilityInfo `protobuf:"bytes,1,opt,name=capability_info,json=capability_info" json:"capability_info,omitempty"` // Deprecated: Do not use.
	...
	// has its own rootfs).
	IpcMode *LinuxInfo_IpcMode `protobuf:"varint,6,opt,name=ipc_mode,json=ipc_mode,enum=mesos.v1.LinuxInfo_IpcMode" json:"ipc_mode,omitempty"`
	...
	ShmSize              *uint32  `protobuf:"varint,7,opt,name=shm_size,json=shm_size" json:"shm_size,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *LinuxInfo) GetIpcMode() LinuxInfo_IpcMode {
	if m != nil && m.IpcMode != nil {
		return *m.IpcMode
	}
	return LinuxInfo_UNKNOWN
}

func (m *LinuxInfo) GetShmSize() uint32 {
	if m != nil && m.ShmSize != nil {
		return *m.ShmSize
	}
	return 0
}
...
type ContainerInfo_DockerInfo struct {
	...
	VolumeDriver         *string  `protobuf:"bytes,7,opt,name=volume_driver,json=volume_driver" json:"volume_driver,omitempty"` // Deprecated: Do not use.
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
type DrainConfig struct {
	...
	MaxGracePeriod *DurationInfo `protobuf:"bytes,1,opt,name=max_grace_period,json=max_grace_period" json:"max_grace_period,omitempty"`
	...
	MarkGone             *bool    `protobuf:"varint,2,opt,name=mark_gone,json=mark_gone,def=0" json:"mark_gone,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *DrainConfig) Reset()         { *m = DrainConfig{} }
func (m *DrainConfig) String() string { return proto.CompactTextString(m) }
func (*DrainConfig) ProtoMessage()    {}
func (*DrainConfig) Descriptor() ([]byte, []int) {
	return fileDescriptor_9ae6ea93b6aa08a0, []int{88}
}

func (m *DrainConfig) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DrainConfig.Unmarshal(m, b)
}
func (m *DrainConfig) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DrainConfig.Marshal(b, m, deterministic)
}
func (m *DrainConfig) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DrainConfig.Merge(m, src)
}
func (m *DrainConfig) XXX_Size() int {
	return xxx_messageInfo_DrainConfig.Size(m)
}
func (m *DrainConfig) XXX_DiscardUnknown() {
	xxx_messageInfo_DrainConfig.DiscardUnknown(m)
}

var xxx_messageInfo_DrainConfig proto.InternalMessageInfo

const Default_DrainConfig_MarkGone bool = false

func (m *DrainConfig) GetMaxGracePeriod() *DurationInfo {
	if m != nil {
...
func (m *DrainConfig) GetMarkGone() bool {
...
func (m *DrainInfo) Reset()         { *m = DrainInfo{} }
func (m *DrainInfo) String() string { return proto.CompactTextString(m) }
func (*DrainInfo) ProtoMessage()    {}
func (*DrainInfo) Descriptor() ([]byte, []int) {
	return fileDescriptor_9ae6ea93b6aa08a0, []int{89}
}

func (m *DrainInfo) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_DrainInfo.Unmarshal(m, b)
}
func (m *DrainInfo) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_DrainInfo.Marshal(b, m, deterministic)
}
func (m *DrainInfo) XXX_Merge(src proto.Message) {
	xxx_messageInfo_DrainInfo.Merge(m, src)
}
func (m *DrainInfo) XXX_Size() int {
	return xxx_messageInfo_DrainInfo.Size(m)
}
func (m *DrainInfo) XXX_DiscardUnknown() {
	xxx_messageInfo_DrainInfo.DiscardUnknown(m)
}

var xxx_messageInfo_DrainInfo proto.InternalMessageInfo

func (m *DrainInfo) GetState() DrainState {
	if m != nil && m.State != nil {
		return *m.State
	}
...
func (m *DrainInfo) GetConfig() *DrainConfig {
	if m != nil {
		return m.Config
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("mesos.v1.DrainState", DrainState_name, DrainState_value)
	...
	proto.RegisterEnum("mesos.v1.LinuxInfo_IpcMode", LinuxInfo_IpcMode_name, LinuxInfo_IpcMode_value)
	...
	proto.RegisterType((*DrainConfig)(nil), "mesos.v1.DrainConfig")
	proto.RegisterType((*DrainInfo)(nil), "mesos.v1.DrainInfo")
}

func init() { proto.RegisterFile("mesos.proto", fileDescriptor_9ae6ea93b6aa08a0) }

var fileDescriptor_9ae6ea93b6aa08a0 = []byte{
	// 11643 bytes of a gzipped FileDescriptorProto
	,
}
