...
type OfferOperationState int32

const (
	// Default value if the enum is not set. See MESOS-4997.
	OfferOperationState_OFFER_OPERATION_UNSUPPORTED OfferOperationState = 0
	// Initial state.
	OfferOperationState_OFFER_OPERATION_PENDING OfferOperationState = 1
	// The operation was successfully applied.
	// This state is terminal.
	OfferOperationState_OFFER_OPERATION_FINISHED OfferOperationState = 2
	// The operation failed to apply.
	// This state is terminal.
	OfferOperationState_OFFER_OPERATION_FAILED OfferOperationState = 3
	// The operation description contains an error.
	OfferOperationState_OFFER_OPERATION_ERROR OfferOperationState = 4
)

var OfferOperationState_name = map[int32]string{
	0: "OFFER_OPERATION_UNSUPPORTED",
	1: "OFFER_OPERATION_PENDING",
	2: "OFFER_OPERATION_FINISHED",
	3: "OFFER_OPERATION_FAILED",
	4: "OFFER_OPERATION_ERROR",
}
var OfferOperationState_value = map[string]int32{
...
func (x OfferOperationState) Enum() *OfferOperationState {
	p := new(OfferOperationState)
	*p = x
	return p
}
func (x OfferOperationState) String() string {
	return proto.EnumName(OfferOperationState_name, int32(x))
}
func (x *OfferOperationState) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(OfferOperationState_value, data, "OfferOperationState")
	if err != nil {
		return err
	}
	*x = OfferOperationState(value)
	return nil
}
func (OfferOperationState) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (TaskStatus_Source) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{50, 0} }
...
func (TaskStatus_Reason) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{50, 1} }
...
func (Secret_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{57, 0} }
...
func (Image_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{60, 0} }
...
func (MountPropagation_Mode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{61, 0} }
...
func (Volume_Mode) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{62, 0} }
...
func (Volume_Source_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{62, 0, 0} }
...
func (Volume_Source_SandboxPath_Type) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor0, []int{62, 0, 2, 0}
}
...
func (NetworkInfo_Protocol) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{63, 0} }
...
func (ContainerInfo_Type) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{68, 0} }
...
func (CgroupInfo_Blkio_Operation) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor0, []int{70, 0, 0}
}
...
func (DiscoveryInfo_Visibility) EnumDescriptor() ([]byte, []int) { return fileDescriptor0, []int{75, 0} }
...
type OfferOperationID struct {
	Value            *string `protobuf:"bytes,1,req,name=value" json:"value,omitempty"`
	XXX_unrecognized []byte  `json:"-"`
}

func (m *OfferOperationID) Reset()                    { *m = OfferOperationID{} }
func (m *OfferOperationID) String() string            { return proto.CompactTextString(m) }
func (*OfferOperationID) ProtoMessage()               {}
func (*OfferOperationID) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }

func (m *OfferOperationID) GetValue() string {
	if m != nil && m.Value != nil {
		return *m.Value
	}
	return ""
...
type Offer_Operation struct {
	...
	Id               *OfferOperationID              `protobuf:"bytes,12,opt,name=id" json:"id,omitempty"`
...
func (m *Offer_Operation) GetId() *OfferOperationID {
	if m != nil {
		return m.Id
	}
	return nil
...
type OfferOperation struct {
	...
	LatestStatus *OfferOperationStatus `protobuf:"bytes,4,req,name=latest_status,json=latest_status" json:"latest_status,omitempty"`
	...
	Statuses []*OfferOperationStatus `protobuf:"bytes,5,rep,name=statuses" json:"statuses,omitempty"`
	...
	// optional.
	OperationUuid    []byte `protobuf:"bytes,6,req,name=operation_uuid,json=operation_uuid" json:"operation_uuid,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}
...
func (*OfferOperation) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{47} }

func (m *OfferOperation) GetFrameworkId() *FrameworkID {
	if m != nil {
		return m.FrameworkId
	}
	return nil
...
func (m *OfferOperation) GetAgentId() *AgentID {
	if m != nil {
		return m.AgentId
	}
	return nil
...
func (m *OfferOperation) GetInfo() *Offer_Operation {
	if m != nil {
		return m.Info
	}
	return nil
...
func (m *OfferOperation) GetLatestStatus() *OfferOperationStatus {
	if m != nil {
...
func (m *OfferOperation) GetStatuses() []*OfferOperationStatus {
	if m != nil {
		return m.Statuses
	}
	return nil
...
func (m *OfferOperation) GetOperationUuid() []byte {
	if m != nil {
...
type OfferOperationStatus struct {
	OperationId *OfferOperationID    `protobuf:"bytes,1,opt,name=operation_id,json=operation_id" json:"operation_id,omitempty"`
	State       *OfferOperationState `protobuf:"varint,2,req,name=state,enum=mesos.v1.OfferOperationState" json:"state,omitempty"`
	...
	StatusUuid       []byte `protobuf:"bytes,5,opt,name=status_uuid,json=status_uuid" json:"status_uuid,omitempty"`
	XXX_unrecognized []byte `json:"-"`
}

func (m *OfferOperationStatus) Reset()                    { *m = OfferOperationStatus{} }
func (m *OfferOperationStatus) String() string            { return proto.CompactTextString(m) }
func (*OfferOperationStatus) ProtoMessage()               {}
func (*OfferOperationStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{48} }

func (m *OfferOperationStatus) GetOperationId() *OfferOperationID {
	if m != nil {
...
func (m *OfferOperationStatus) GetState() OfferOperationState {
	if m != nil && m.State != nil {
		return *m.State
	}
	return OfferOperationState_OFFER_OPERATION_UNSUPPORTED
}

func (m *OfferOperationStatus) GetMessage() string {
...
func (m *OfferOperationStatus) GetConvertedResources() []*Resource {
	if m != nil {
...
func (m *OfferOperationStatus) GetStatusUuid() []byte {
	if m != nil {
		return m.StatusUuid
	}
	return nil
...
func (*CheckStatusInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{49} }
...
func (*CheckStatusInfo_Command) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{49, 0} }
...
func (*CheckStatusInfo_Http) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{49, 1} }
...
func (*CheckStatusInfo_Tcp) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{49, 2} }
...
func (*TaskStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{50} }
...
func (*Filters) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{51} }
...
func (*Environment) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{52} }
...
func (*Environment_Variable) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{52, 0} }
...
func (*Parameters) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{54} }
...
func (*Credential) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{55} }
...
func (*Credentials) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{56} }
...
func (*Secret) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{57} }
...
func (*Secret_Reference) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{57, 0} }
...
func (*Secret_Value) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{57, 1} }
...
func (*RateLimit) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{58} }
...
func (*RateLimits) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{59} }
...
func (*Image) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{60} }
...
func (*Image_Appc) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{60, 0} }
...
func (*Image_Docker) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{60, 1} }
...
func (*MountPropagation) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{61} }
...
func (*Volume) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{62} }
...
func (*Volume_Source) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{62, 0} }
...
func (*Volume_Source_DockerVolume) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{62, 0, 0}
}
...
func (*Volume_Source_HostPath) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{62, 0, 1} }
...
func (*Volume_Source_SandboxPath) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{62, 0, 2}
}
...
func (*NetworkInfo_IPAddress) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{63, 0} }
...
func (*NetworkInfo_PortMapping) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{63, 1} }
...
func (*CapabilityInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{64} }
...
func (*LinuxInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{65} }
...
func (*RLimitInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{66} }
...
func (*RLimitInfo_RLimit) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{66, 0} }
...
func (*TTYInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{67} }
...
func (*TTYInfo_WindowSize) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{67, 0} }
...
func (*ContainerInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{68} }
...
func (*ContainerInfo_DockerInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{68, 0} }
...
func (*ContainerInfo_MesosInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{68, 1} }
...
func (*ContainerStatus) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{69} }
...
func (*CgroupInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{70} }
...
func (*CgroupInfo_Blkio) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{70, 0} }
...
func (*CgroupInfo_Blkio_Value) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{70, 0, 0} }
...
func (*CgroupInfo_Blkio_CFQ) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{70, 0, 1} }
...
func (*CgroupInfo_Blkio_CFQ_Statistics) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{70, 0, 1, 0}
}
...
func (*CgroupInfo_Blkio_Throttling) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{70, 0, 2}
}
...
func (*CgroupInfo_Blkio_Throttling_Statistics) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{70, 0, 2, 0}
}
...
func (*CgroupInfo_Blkio_Statistics) Descriptor() ([]byte, []int) {
	return fileDescriptor0, []int{70, 0, 3}
}
...
func (*CgroupInfo_NetCls) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{70, 1} }
...
func (*Labels) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{71} }
...
func (*Label) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{72} }
...
func (*Port) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{73} }
...
func (*Ports) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{74} }
...
func (*DiscoveryInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{75} }
...
func (*WeightInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{76} }
...
func (*VersionInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{77} }
...
func (*Flag) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{78} }
...
func (*Role) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{79} }
...
func (*Metric) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{80} }
...
func (*FileInfo) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{81} }
...
func (*Device) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{82} }
...
func (*Device_Number) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{82, 0} }
...
func (*DeviceAccess) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{83} }
...
func (*DeviceAccess_Access) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{83, 0} }
...
func (*DeviceWhitelist) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{84} }
...
func init() {
	...
	proto.RegisterType((*OfferOperationID)(nil), "mesos.v1.OfferOperationID")
	...
	proto.RegisterType((*OfferOperation)(nil), "mesos.v1.OfferOperation")
	proto.RegisterType((*OfferOperationStatus)(nil), "mesos.v1.OfferOperationStatus")
	...
	proto.RegisterEnum("mesos.v1.OfferOperationState", OfferOperationState_name, OfferOperationState_value)
...
var fileDescriptor0 = []byte{
	// 10995 bytes of a gzipped FileDescriptorProto
	,
}
