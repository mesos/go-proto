...
import (
	...
	allocator "github.com/mesos/go-proto/mesos/v1/allocator"
	math "math"
)
...
type Window struct {
	...
	MachineIds []*v1.MachineID `protobuf:"bytes,1,rep,name=machine_ids,json=machine_ids" json:"machine_ids,omitempty"`
...
type ClusterStatus struct {
	DrainingMachines     []*ClusterStatus_DrainingMachine `protobuf:"bytes,1,rep,name=draining_machines,json=draining_machines" json:"draining_machines,omitempty"`
	DownMachines         []*v1.MachineID                  `protobuf:"bytes,2,rep,name=down_machines,json=down_machines" json:"down_machines,omitempty"`
	XXX_NoUnkeyedLiteral struct{}                         `json:"-"`
	XXX_unrecognized     []byte                           `json:"-"`
	XXX_sizecache        int32                            `json:"-"`
}
...
func (*ClusterStatus) Descriptor() ([]byte, []int) {
	return fileDescriptor_6053ae89a3b3f561, []int{2}
}
...
func (*ClusterStatus_DrainingMachine) Descriptor() ([]byte, []int) {
	return fileDescriptor_6053ae89a3b3f561, []int{2, 0}
}
