...
import mesos_v1_allocator "github.com/mesos/go-proto/mesos/v1/allocator"
...
type Window struct {
	...
	MachineIds []*mesos_v1.MachineID `protobuf:"bytes,1,rep,name=machine_ids,json=machine_ids" json:"machine_ids,omitempty"`
...
type ClusterStatus struct {
	...
	DownMachines     []*mesos_v1.MachineID            `protobuf:"bytes,2,rep,name=down_machines,json=down_machines" json:"down_machines,omitempty"`
	XXX_unrecognized []byte                           `json:"-"`
}
